...
This site is built using the Jekyll Now repository as a template. The description of Jekyll Now is below. [Click here to visit the actual IsraelFellow site](http://www.afellowinisrael.com/).
